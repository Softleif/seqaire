...
BCF positions are 0-based. The encoder MUST subtract 1 from the 1-based position when encoding. CHROM MUST be encoded as the contig's integer tid from the pre-resolved `ContigId`.
