...
The `Phred` newtype wraps the mathematical definition: `Q = -10 log10(P)`.

> **Sources:** Phred quality scores are defined in [SAM1] section 1.4 (QUAL field, Phred+33 encoding). See [References](./99-references.md).
